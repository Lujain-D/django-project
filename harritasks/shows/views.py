...
def predict_rating(request):
    if request.method == 'POST':
        ...
        return HttpResponse({"status": 400, "message": "wrong method"})
...
def predict_best_application(request):
    if request.method == 'POST':
        ...
        # classifier.load_config("harritasks/shows/xg_classifier.json")
        # classifier = joblib.load("harritasks/shows/xg_classifier.sav")
